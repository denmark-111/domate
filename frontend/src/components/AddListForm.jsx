...
const AddListForm = ({ onSubmit, onCancel }) => {
  ...
  return (
    <div className="w-80 flex-shrink-0 flex flex-col gap-4">
      <div className="px-2">
        <h3 className="text-sm font-bold text-gray-600 uppercase tracking-wider">New List</h3>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-blue-50 p-3 rounded-lg border-2 border-blue-300 space-y-3">
        <input
          ...
          className="w-full px-3 py-2 rounded border border-blue-200 bg-white outline-none focus:border-blue-500 text-sm font-medium"
          autoFocus
        />
