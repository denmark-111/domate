...
const TaskCard = ({ task, sortableId, onClick, onDelete, onToggleComplete, lockInfo }) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
      className={`bg-surface-container-lowest p-3.5 rounded-DEFAULT border border-outline-variant hover:border-primary transition-all duration-200 cursor-pointer group relative shadow-2xs space-y-2.5 ${
