...
import { createTaskSchema, updateTaskSchema, taskIdParamSchema, moveTaskSchema, getMyTasksQuerySchema } from "../schemas/taskSchema.js";
...
router.get('/my', validate(getMyTasksQuerySchema), asyncHandler(getMyTasks));
