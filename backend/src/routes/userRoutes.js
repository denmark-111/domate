...
import { searchMyStuff } from "../controllers/searchController.js";
...
import { searchMyStuffSchema } from "../schemas/searchSchema.js";
...
router.get('/me/search', validate(searchMyStuffSchema), asyncHandler(searchMyStuff));
